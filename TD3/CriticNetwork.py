...
class CriticNetwork(nn.Module):
    def __init__(self, n_states, n_actions, alpha, checkpoint_path='/home/nam/Reinforcement_learning/TD3'):
        ...
        self.dirPath = os.path.join(self.checkpoint_path, 'torch_TD3_critic_2')
    ...
    def save_models(self):
        ...
        T.save(self.optimizer.state_dict(), self.dirPath + '_optimizer_2')

    def load_models(self):
        self.load_state_dict(T.load(self.dirPath))
        self.optimizer.load_state_dict(T.load(self.dirPath + '_optimizer_2'))