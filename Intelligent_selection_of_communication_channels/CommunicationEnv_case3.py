...
class CommunicationEnv_case3:
    ...
    def reset(self):
        ...
        index_t = [1, 3, 5]
        index_t_j = np.random.choice(len(channel_t), 1)
        # PH = []
        # psd = []
        ...
        for j in range(len(index_t_j)):
            channel_t[index_t_j[j]] += self.phj
        ac_t = [0]
    ...
    def step(self, action):
        ...
        index_t1 = [1, 3, 5]
        index_t1_j = np.random.choice(len(channel_t1), 1)
        # PH = []
        # psd = []
        ...
        for j in range(len(index_t1_j)):
            channel_t1[index_t1_j[j]] += self.phj
        ac_t1 = action
