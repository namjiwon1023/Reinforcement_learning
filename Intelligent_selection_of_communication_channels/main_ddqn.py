...
if __name__ == "__main__":
    ...
    figure_file = '/home/nam/Reinforcement_learning/Intelligent_selection_of_communication_channels/plots/DDQN_Interference_Avoidance.png'
    ...
    for e in range(agent.load_episode, 10001):
        ...
        np.savetxt("./DDQN_Total_reward.txt",scores, delimiter=",")
        np.savetxt("./DDQN_avg_reward.txt",avg_scores, delimiter=",")
