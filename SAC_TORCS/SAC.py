...
class SACAgent:
    def __init__(self, **kwargs):
        ...
        dirPath='/home/nam/Reinforcement_learning/SAC_TORCS'
    ...
    def learn(self):
        ...
        action = T.FloatTensor(samples["action"]).reshape(-1, 3).to(self.actor.device)
...
if __name__ == "__main__":
    ...
    for e in range(1, EPISODE_COUNT + 1):
        ...
        for i in range(MAX_STEPS):
            ...
            state_ = np.hstack((ob.angle, ob.track, ob.trackPos, ob.speedX, ob.speedY, ob.speedZ, ob.wheelSpinVel/100.0, ob.rpm))
